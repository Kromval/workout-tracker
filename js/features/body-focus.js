export const BODY_FOCUS_MUSCLE_GROUPS = Object.freeze({
  upperBody: Object.freeze(['chest', 'back', 'shoulders', 'arms', 'biceps', 'triceps', 'lats', 'upper-back']),
  lowerBody: Object.freeze(['legs', 'quads', 'hamstrings', 'glutes', 'calves', 'adductors', 'abductors']),
